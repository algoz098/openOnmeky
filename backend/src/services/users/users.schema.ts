...
export const validRoles = ['super-admin', 'admin', 'editor', 'viewer'] as const
...
export const userSchema = Type.Object(
  {
    ...
    role: Type.Optional(
      Type.Union(
        validRoles.map(r => Type.Literal(r)),
        { default: 'viewer' }
      )
    )
  },
...
export const userDataSchema = Type.Pick(userSchema, ['email', 'password', 'name', 'role'], {
  $id: 'UserData'
})
